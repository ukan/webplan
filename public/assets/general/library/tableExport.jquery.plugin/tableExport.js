...
(function($){
    $.fn.extend({
        ...
        if(defaults.type == 'csv' || defaults.type == 'txt'){
            ...
            download('data:text/plain;'+base64data,defaults.tableName + '.'+defaults.type,'text/plain');
            ...
            download('data:application/json;'+base64data,defaults.tableName + '.'+defaults.type,'application/json');
            ...
            download('data:application/xml;'+base64data,defaults.tableName + '.'+defaults.type,'application/xml');

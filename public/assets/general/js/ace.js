    ...
    var r = e("../lib/event"),
        ...
        f = function(e, t) {
            ...
            r.addListener(n, "compositionstart", B), i.isGecko ? r.addListener(n, "text", function() {
                ...
                t.renderer.$keepTextAreaAtCursor && (t.renderer.$keepTextAreaAtCursor = null), i.isWin && r.capture(t.container, h, q)
        ...
        this.$setMaxTokenCount = function(e) {
            ...
            while (a = u.exec(e)) {
                ...
                for (var g = 0; g < a.length - 2; g++) {
                    ...
                    p = s[o[g]], p.onMatch ? h = p.onMatch(d, i, n) : h = p.token, p.next && (typeof p.next == "string" ? (n.length && n[0] == i && n[1] == p.next && n.shift(), i = p.next) : i = p.next(i, n), s = this.states[i], s || (window.console && console.error && console.error(i, "doesn't exist"), i = "start", s = this.states[i]), o = this.matchMappings[i], l = v, u = this.regExps[i], u.lastIndex = v);
                    break
                }
                if (d)
    ...
    (function() {
        ...
        this.$computeWrapSplits = function(e, t) {
            ...
            while (i - s > t) {
                ...
                var h = Math.max(c - (a ? 10 : t - (t >> 2)), s - 1);
                while (c > h && e[c] < n) c--;
                if (a) {
                    while (c > h && e[c] < n) c--;
                    while (c > h && e[c] == l) c--
